...
class HomeController extends AbstractController
{
     ...
     * @param $imageTransformer ImageTransformer
     */
    public function negate(Request $request, SessionInterface $session, EntityManagerInterface $entityManager, ImageTransformer $imageTransformer)
    {
        if($session->getId())
        {
            /** @var Image $image */
            ...
            if ($request->getMethod() == 'POST') {
                ...
                $image = $imageTransformer->negate($image);
     ...
     * @param $imageTransformer ImageTransformer
     */
    public function edgeDetection(Request $request, SessionInterface $session, EntityManagerInterface $entityManager, ImageTransformer $imageTransformer)
    {
        if($session->getId())
        {
            /** @var Image $image */
            ...
            if ($request->getMethod() == 'POST') {
                ...
                $image = $imageTransformer->edgeDetection($image);
     ...
     * @param $imageTransformer ImageTransformer
     */
    public function meanRemoval(Request $request, SessionInterface $session, EntityManagerInterface $entityManager, ImageTransformer $imageTransformer)
    {
        if($session->getId())
        {
            /** @var Image $image */
            ...
            if ($request->getMethod() == 'POST') {
                ...
                $image = $imageTransformer->meanRemoval($image);
